...
public class Main {
    ...
    private static void populate() {
        ...
        Book b = new Book("Murder on the Orient Express", agathaChristie, "Thriller", reviews1, 256, "Collins Crime Club");
        ...
        LibraryServices.setLibraries(libraries);
        UserServices.setUsersList(usersList);
    }
